...
for IDX in $(seq 0 $((CHUNKS-1))); do
    ...
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python ./muffin/eval/llava15_vlind0.py \
        --model-path .ckpt/llava15_7b_DPO-llava15_rlhfv/checkpoints/checkpoint-630 \
